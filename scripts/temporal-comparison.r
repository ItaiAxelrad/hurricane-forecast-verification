...
day_vec <- seq(as.Date("2002-09-07"), as.Date("2002-10-04"), by <- "Days")
...
for (i in 1:days) {
  ...
  ens_avg <- (ens1_mask + ens2_mask + ens3_mask + ens4_mask + ens5_mask + ens6_mask + ens7_mask + ens8_mask + ens9_mask + ens10_mask) / 10
