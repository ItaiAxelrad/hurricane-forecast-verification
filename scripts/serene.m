...
Ens_file1 = 'CanCM4_EnsNo-1_LeadTime-0_Hurricane-Isidore_20020907-20021004.nc';
Ens1 = netcdf.open(Ens_file1);
ncdisp(Ens_file1);

Ens_file2 = 'CanCM4_EnsNo-2_LeadTime-0_Hurricane-Isidore_20020907-20021004.nc';
Ens2 = netcdf.open(Ens_file2);

Ens_file3 = 'CanCM4_EnsNo-3_LeadTime-0_Hurricane-Isidore_20020907-20021004.nc';
Ens3 = netcdf.open(Ens_file3);

Ens_file4 = 'CanCM4_EnsNo-4_LeadTime-0_Hurricane-Isidore_20020907-20021004.nc';
Ens4 = netcdf.open(Ens_file4);

Ens_file5 = 'CanCM4_EnsNo-5_LeadTime-0_Hurricane-Isidore_20020907-20021004.nc';
Ens5 = netcdf.open(Ens_file5);

Ens_file6 = 'CanCM4_EnsNo-6_LeadTime-0_Hurricane-Isidore_20020907-20021004.nc';
Ens6 = netcdf.open(Ens_file6);

Ens_file7 = 'CanCM4_EnsNo-7_LeadTime-0_Hurricane-Isidore_20020907-20021004.nc';
Ens7 = netcdf.open(Ens_file7);

Ens_file8 = 'CanCM4_EnsNo-8_LeadTime-0_Hurricane-Isidore_20020907-20021004.nc';
Ens8 = netcdf.open(Ens_file8);

Ens_file9 = 'CanCM4_EnsNo-9_LeadTime-0_Hurricane-Isidore_20020907-20021004.nc';
Ens9 = netcdf.open(Ens_file9);

Ens_file10 = 'CanCM4_EnsNo-10_LeadTime-0_Hurricane-Isidore_20020907-20021004.nc';
...
%plot figures for Observed, Forecasted, and Difference Between the Two
figure(1)
s1 = subplot(2, 2, 1)
map = pcolor(longitude, latitude, mask_Ens); xlabel('Longitude'); title('Forecast (All Ensembles)'); ylabel('Latitude'); hold on;
set(map, 'EdgeColor', 'none');
legend = colorbar; title(legend, 'Precipitation (mm/day)'); grid off; hold on;

s2 = subplot(2, 2, 2)
map = pcolor(longitude, latitude, mask_TRMM); xlabel('Longitude'); title('Observed (TRMM)'); ylabel('Latitude'); hold on;
set(map, 'EdgeColor', 'none');
legend = colorbar; title(legend, 'Precipitation (mm/day)');

s3 = subplot(2, 2, 3)
map = pcolor(longitude, latitude, ratio); xlabel('Longitude'); title('Scaling Error (TRMM:Ensemble)'); ylabel('Latitude'); hold on;
set(map, 'EdgeColor', 'none');
legend = colorbar;
colormap(s3, hot);

s4 = subplot(2, 2, 4)
NOAA = imagesc(imread('Isidore.png')); set(gca, 'xtick', [], 'ytick', []); title('NOAA Hurricane Map');
